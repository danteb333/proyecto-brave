    ...
    public void cargarURL(String nombreArchivo, JLabel estado) {
        ...
        try {
            ...
            if (!conectado) {
                ...
                String htmlDescargado = clienteHTTP.getContenido();

                if (htmlDescargado != null) {

                    String htmllimpio = html(htmlDescargado);

                    String htmlFinalConAvisos = procesarEtiquetasNoSoportadas(htmlLimpio);

                    visorHTML.setText(htmlFinalConAvisos);
                }
                return;
            }
